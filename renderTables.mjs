...
import { renderOrderList, renderPizzaTable } from "./renderTables.mjs";
...
function resetOrderList() {
  ...
  renderPizzaTable(orderArray); // Clear the pizza table content and add the header
}
